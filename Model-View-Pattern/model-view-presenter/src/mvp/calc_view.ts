import {CALC as calc} from "./calc_presenter";
...
export namespace CALC.mvp {
    ...
    import CalcPresenter = calc.mvp.CalcPresenter;
    ...
    export class CalcView {
        ...
        */
        ...
        redraw(): void {
            ...
            /*
            firstNumber = calcModel.getFirstNumber()
            secondNumber = calcModel.getSecondNumber()
            */
        ...
        */
        ...
        setCalcPresenter(calcPresenter: CalcPresenter): void {
